...
const WishBookList = ({ wish }) => {
    // eslint-disable-next-line react/prop-types
    const {id,bookName,author,image,yearOfPublishing,publisher,totalPages,category,tags,rating} =wish;
  return (
    <div>
    ...
    <div className="flex gap-6 flex-col lg:flex-row   pb-4">
